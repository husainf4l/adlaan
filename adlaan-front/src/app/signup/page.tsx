...
export default function SignUpPage() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      // Call the GraphQL signup mutation with ADMIN role
      ...
      // Redirect to company setup page after successful registration
      setTimeout(() => {
          ...
          <CardContent className="space-y-6">
            ...
            {success && (
              <div className="p-3 bg-green-500/10 border border-green-500/20 rounded-lg">
                <p className="text-sm text-green-400">Account created successfully! Redirecting to sign in...</p>
              </div>
            )}
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-start">
                <input
                  ...
                  disabled={isLoading}
                  className="h-4 w-4 mt-0.5 rounded border-white/10 bg-black text-white focus:ring-2 focus:ring-white/20 disabled:opacity-50"
                />
