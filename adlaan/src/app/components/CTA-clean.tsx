  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 lg:px-8">
        {/* Main CTA Content */}
        <div
          className={`mx-auto max-w-4xl text-center mb-16 transition-all duration-1000 ease-out ${
        ...
        {/* Trust Indicators */}
        <div
          className={`grid grid-cols-1 md:grid-cols-3 gap-8 transition-all duration-1000 delay-300 ease-out ${
