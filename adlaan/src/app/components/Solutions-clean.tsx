  ...
  const solutions = [
    {
      ...
      description:
        "Streamline contract drafting, due diligence, and legal documentation with AI that understands complex commercial relationships.",
      features: [
        "Contract Generation",
    ...
    },
    {
      ...
      description:
        "Create policy documents, regulations, and public agreements that balance legal requirements with cultural sensitivity.",
      features: [
        "Policy Drafting",
    ...
    },
    {
      ...
      description:
        "Access enterprise-level legal AI without the complexity, perfect for growing businesses in the MENA region.",
      features: [
        "Employee Contracts",
        "Vendor Agreements",
        "Compliance Checks",
    ...
    },
    {
      ...
      description:
        "Navigate complex healthcare regulations while maintaining patient privacy and cultural healthcare practices.",
      features: [
        "HIPAA Compliance",
        "Research Agreements",
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl lg:text-2xl font-light text-gray-600 leading-relaxed max-w-3xl mx-auto">
            From startups to enterprises, Adlaan scales with your organization
            while maintaining the highest standards of legal accuracy and
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {industries.map((industry, index) => (
                <div key={index} className="text-center">
                  ...
                  <div className="text-sm text-gray-600">{industry.name}</div>
                </div>
              ))}
            </div>
          </div>
        ...
        >
          ...
          <p className="text-lg text-gray-600 mb-8">
            Supporting legal professionals from Dubai to Riyadh, from Cairo to
            Casablanca
          </p>
